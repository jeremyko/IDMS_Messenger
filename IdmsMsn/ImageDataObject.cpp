...
void CImageDataObject::InsertBitmap(IRichEditOle* pRichEditOle, HBITMAP hBitmap, CString& strOutID )
{
	SCODE sc;
	...
	reobject.dvaspect = DVASPECT_CONTENT ; //DVASPECT_ICON    ; // DVASPECT_TRANSPARENT ; // DVASPECT_CONTENT; //DVASPECT_TRANSPARENT  
	...
	ltoa((DWORD)reobject.pstg , szKey, 10);	
	strOutID = szKey ;
...
void CImageDataObject::SetBitmap(HBITMAP hBitmap)
{
	...
	fm.dwAspect = DVASPECT_CONTENT; //DVASPECT_CONTENT;			// Level of detail = Full content
