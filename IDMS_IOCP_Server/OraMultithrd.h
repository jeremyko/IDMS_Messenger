...
//		}
		 ...
		 *******************************************************************************/
		void setNotiProcThread(ORANOTIFYPROC pNotifyProc, CIocpServer* pWnd) 
		{
			m_pNotifyProc	= pNotifyProc;
			m_pThread		=  pWnd; //!!
		}
		...
		BOOL process() throw() 
		{
			...
			*/
			...
			oresult nRslt = odb.Open( osess,	CServerGlobal::Instance().m_strDBConn, 
												CServerGlobal::Instance().m_strUser, 
												CServerGlobal::Instance().m_strPassWd	);
